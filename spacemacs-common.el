...
;;;;; lsp
     ...
     `(lsp-ui-peek-list ((,class (:background nil))))
     `(lsp-ui-peek-peek ((,class (:background nil))))
;;;;; magit
...
;;;;; mode-line
     ...
     `(mode-line-inactive  ((,class (:foreground ,base-dim :background ,bg1  :box nil))))
...
;;;;; org
     ...
     `(org-block ((,class (:background nil :foreground ,accent-dark-gray))))
     `(org-block-begin-line ((,class (:background nil :height 0.6 :foreground ,accent-shade-3))))
     `(org-block-end-line ((,class (:background nil :height 0.6 :foreground ,accent-shade-3))))
     ...
     `(org-document-title ((,class (:foreground ,gray :inherit variable-pitch :height ,(if spacemacs-theme-org-height 1.4 1.0) :underline t))))
...
;;;;; org-ref
     `(org-ref-cite-face ((, class (:foreground ,builtin))))
     `(org-ref-ref-face ((, class (:foreground ,builtin :inherit org-link))))
